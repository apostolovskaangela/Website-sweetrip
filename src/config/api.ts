...
// - Physical Device: 'http://YOUR_IP_ADDRESS:8000/api' (e.g., 'http://192.168.1.104:8000/api')
//
// Set your backend URL here:
const DEV_BASE_URL = Platform.select({
  android: 'http://192.168.1.104:8000/api', // Android emulator
  ios: 'http://192.168.1.104:8000/api', // iOS simulator
  default: 'http://192.168.1.104:8000/api', // Web/fallback
});

// TODO: Replace with your actual backend IP address for physical devices
// Example: 'http://192.168.1.104:8000/api'
// Uncomment and set this if testing on a physical device:
// const DEV_BASE_URL = 'http://192.168.1.104:8000/api';
